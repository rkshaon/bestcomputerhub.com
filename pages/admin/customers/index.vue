...
<template>
  <div class="space-y-6">
    ...
    <div class="bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-[2.5rem] shadow-sm overflow-hidden">
      <div class="p-6 border-b border-slate-100 dark:border-slate-900 flex flex-col md:flex-row md:items-center gap-4">
        ...
        <div class="flex items-center gap-3">
          <button class="h-11 px-4 bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-2xl text-xs font-bold uppercase tracking-widest flex items-center gap-2 hover:bg-slate-50">
