<!-- File: /pages/admin/content-security/components/ScanRunModal.vue -->
...
import type { ContentScanRunRequest } from '@/types/content-security';
...
const fetchAvailableScanObjects = async () => {
  ...
  try {
    ...
    const list: Array<{ id: string | number; label: string; sublabel?: string; type: string; typeLabel: string }> = [];
