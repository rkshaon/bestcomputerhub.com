      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16">
        ...
        <div class="space-y-3 sm:space-y-4">
          <div class="flex flex-col-reverse sm:flex-row items-center sm:items-start justify-center sm:justify-start gap-2 sm:gap-3">
            ...
            <!-- Main Product Image -->
            <div class="flex-1 min-w-0 w-full aspect-square mx-auto sm:mx-0 rounded-2xl sm:rounded-3xl lg:rounded-[2rem] overflow-hidden bg-muted/40 border group relative flex items-center justify-center p-2">
              <img 
                v-if="selectedImage" 
                :src="selectedImage" 
