      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16">
        ...
        <div class="space-y-4 sm:space-y-6">
          <div class="flex flex-col-reverse sm:flex-row items-center sm:items-start justify-center sm:justify-start gap-3 sm:gap-4">
            ...
            <!-- Main Product Image -->
            <div class="w-[500px] h-[440px] max-w-full mx-auto sm:mx-0 rounded-2xl sm:rounded-3xl lg:rounded-[2rem] overflow-hidden bg-muted/40 border group relative flex items-center justify-center p-2 shrink-0">
              <img 
                v-if="selectedImage" 
                :src="selectedImage" 
