...
| `useBlogService` | Blog Posts & Tags | `/api/v1/blog/posts/`, `/api/v1/blog/tags/`, `/api/v1/blog/posts/{id}/categories/` | Blog post queries by tag/category/author, post detail by ID/slug, blog post category assignment (`assignBlogPostCategories`), blog tag CRUD operations. |
